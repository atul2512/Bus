...
public class Buses {
    ...
    public StationList get_station(String filename) {
    ...
    public String get_redbus_data(String origin, String origin_id, String dest, String dest_id, String date,String fileLocation) {
        ...
        write_file(fileLocation, response);
    ...
    public String test() {
        try {
            StationList a = get_station("redbus_station.txt");
            for (int i = 0; i < a.length; i++) {
                System.out.println(a.stations[i].station_name);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }

        return get_redbus_data("Mumbai", "462", "Goa", "210", "24-Jan-2014","test.txt");
